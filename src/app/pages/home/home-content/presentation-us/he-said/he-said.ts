...
@Component({
  selector: 'app-he-said',
  imports: [NgClass, CommonModule],
  templateUrl: './he-said.html',
  styleUrl: './he-said.scss',
})
export class HeSaid implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit() {
    // Gọi lại changeCom sau khi view đã được khởi tạo
    this.changeCom(this.index);
  }

  changeCom(index: number) {
    this.index = index;
    this.companyInfo = this.companyArray[index];
    // Kiểm tra headImg tồn tại trước khi sử dụng
    if (this.headImg && this.headImg.nativeElement) {
